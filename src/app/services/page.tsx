...
export default function ViewServicesPage() {
  ...
  const fetchServices = React.useCallback(async () => {
    ...
    try {
      ...
      setTotalItems(data.totalCount); // ✅ Store total count for pagination display
    } catch (err: any) {
      ...
      <section className="pt-20 pb-20 px-4">
        <div className="container mx-auto">
          ...
          <div className="mb-8 flex gap-2">
            ...
            />
            <Button onClick={fetchServices} className="bg-[#0B2E66] hover:bg-[#1E63CC]">
              Search
            </Button>
          </div>
...
//               className="flex-1 border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
//             />
//             <Button onClick={fetchServices} className="bg-[#0B2E66] hover:bg-[#1E63CC]">Search</Button>
//           </div>
...
//             <Button disabled={pageNumber === 1} onClick={handlePrevPage} className="bg-[#0B2E66] hover:bg-[#1E63CC]">
//               Previous
//             </Button>
//             <span>
//               Page {pageNumber} of {totalPages}
//             </span>
//             <Button disabled={pageNumber === totalPages} onClick={handleNextPage} className="bg-[#0B2E66] hover:bg-[#1E63CC]">
//               Next
//             </Button>
//           </div>
//         </div>
