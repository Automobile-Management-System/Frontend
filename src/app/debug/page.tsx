    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-blue-50 rounded-lg p-6">
        ...
        <ul className="space-y-2 text-sm">
          <li><strong>User exists:</strong> {user ? 'Yes' : 'No'}</li>
          <li><strong>Role:</strong> {user?.role || 'N/A'}</li>
          <li><strong>Email:</strong> {user?.email || 'N/A'}</li>
          <li><strong>Employee ID:</strong> {user?.employeeId || 'Not found'}</li>
          <li><strong>Customer ID:</strong> {user?.customerId || 'Not found'}</li>
          <li><strong>Admin ID:</strong> {user?.adminId || 'Not found'}</li>
          <li><strong>General ID:</strong> {(user as any)?.id || 'Not found'}</li>
        </ul>
      </div>
